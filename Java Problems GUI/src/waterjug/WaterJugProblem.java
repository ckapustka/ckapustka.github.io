...
public class WaterJugProblem extends Problem {
    ...
    public WaterJugProblem() {
        ...
        WaterJugState currentState = new WaterJugState(0, 0);
	...
	WaterJugState cur = (WaterJugState) getCurrentState();
        WaterJugState w = new WaterJugState(2, cur.getJugY());
        WaterJugState w2 = new WaterJugState(cur.getJugX(), 2);
        boolean b = false;
        
        if (w.equals(cur) || w2.equals(cur)) {
            b = true;
        }
